...
var Tree = ({
  ...
  const [internalExpandedKeys, setInternalExpandedKeys] = (0, import_react.useState)(defaultExpandedKeys);
  const [internalSelectedKeys, setInternalSelectedKeys] = (0, import_react.useState)(defaultSelectedKeys);
  const [internalCheckedKeys, setInternalCheckedKeys] = (0, import_react.useState)(defaultCheckedKeys);
  ...
  const handleExpand = (0, import_react.useCallback)(
    (node) => {
      ...
      if (accordion) {
        ...
        newExpandedKeys = isExpanded ? internalExpandedKeys.filter((k) => k !== key) : [...internalExpandedKeys, key];
      }
  ...
  const handleSelect = (0, import_react.useCallback)(
    (node) => {
      ...
      let newSelectedKeys;
      if (multiple) {
        newSelectedKeys = isSelected ? internalSelectedKeys.filter((k) => k !== key) : [...internalSelectedKeys, key];
      } else {
  ...
  const findNode = (0, import_react.useCallback)(
    (key, nodes) => {
      ...
      if (isChecked) {
        ...
        parentKeys.forEach((parentKey) => {
          ...
          if (parentNode) {
            ...
            const allSiblingsChecked = allSiblings.every(
              (siblingKey) => newCheckedKeys.includes(siblingKey)
            );
  ...
  const insertNode = (0, import_react.useCallback)(
    (targetNode, dragNode2, position, nodes) => {
    ...
    (e, node) => {
      ...
      const isChild = (parentKey, childKey, nodes) => {
        ...
        if (node2.node.children) {
          return node2.node.children.some((child) => child.key === childKey) || node2.node.children.some((child) => isChild(child.key, childKey, nodes));
        }
        return false;
      };
      if (isChild(dragNodeKey, dropNodeKey, treeData))
        return;
  ...
  const renderTreeNode = (node, level = 0) => {
    ...
    return /* @__PURE__ */ import_react.default.createElement(
      ...
      /* @__PURE__ */ import_react.default.createElement("span", { className: "ice-tree-node-indent" }, showExpandIcon && /* @__PURE__ */ import_react.default.createElement("span", { className: "ice-tree-switcher", onClick: () => !disabled && handleExpand(node) }, /* @__PURE__ */ import_react.default.createElement(import_Icon.default, { name: isExpanded ? "icon_double_screen" : "icon_output", size: 16 }))),
      checkable && nodeCheckable !== false && /* @__PURE__ */ import_react.default.createElement("span", { className: checkboxClasses, onClick: handleCheckboxClick }, isChecked && /* @__PURE__ */ import_react.default.createElement(import_Icon.default, { name: "icon_check", size: 16 })),
      /* @__PURE__ */ import_react.default.createElement("span", { className: "ice-tree-node-content", onClick: handleNodeClick }, title),
      isLoading && /* @__PURE__ */ import_react.default.createElement(import_Icon.default, { name: "icon_refresh", size: 14, className: "ice-tree-loading-icon", spin: true }),
      isExpanded && hasChildren && /* @__PURE__ */ import_react.default.createElement("div", { className: "ice-tree-child-nodes" }, children.map((child) => renderTreeNode(child, level + 1)))
    );
  };
  const filteredData = filterValue ? treeData.filter((node) => {
    var _a;
    const title = ((_a = node.title) == null ? void 0 : _a.toString().toLowerCase()) || "";
    return title.includes(filterValue.toLowerCase());
  }) : treeData;
  return /* @__PURE__ */ import_react.default.createElement("div", { className: (0, import_classnames.default)("ice-tree", className), style }, filteredData.map((node) => renderTreeNode(node)));
};
