...
var InputTag = (props) => {
  ...
  const classes = (0, import_classnames.default)(inputTagPrefix, {
    [`${inputTagPrefix}-disabled`]: disabled,
    [`${inputTagPrefix}-focused`]: focused
  }, className);
  return /* @__PURE__ */ import_react.default.createElement("div", { className: classes, style }, /* @__PURE__ */ import_react.default.createElement(import_dnd.DragDropContext, { onDragEnd: handleDragEnd }, /* @__PURE__ */ import_react.default.createElement(import_dnd.Droppable, { droppableId: "tags", direction: "horizontal" }, (provided) => /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
    ...
    tags.map((tag, index) => /* @__PURE__ */ import_react.default.createElement(
      ...
      (provided2) => /* @__PURE__ */ import_react.default.createElement(
        ...
        tag,
        !disabled && !readOnly && /* @__PURE__ */ import_react.default.createElement(
          "span",
          {
