...
var Dialog = ({
  ...
  const renderDialog = () => {
    ...
    return /* @__PURE__ */ import_react.default.createElement(
      ...
      mask && /* @__PURE__ */ import_react.default.createElement("div", { className: maskClass, onClick: handleMaskClick, style: { zIndex } }),
      /* @__PURE__ */ import_react.default.createElement("div", { ref: dialogRef, className: dialogClass, style: dialogStyle }, /* @__PURE__ */ import_react.default.createElement("div", { className: "ice-dialog-header", onMouseDown: handleMouseDown }, /* @__PURE__ */ import_react.default.createElement("div", { className: "ice-dialog-title" }, title), closable && /* @__PURE__ */ import_react.default.createElement("div", { className: "ice-dialog-close", onClick: handleClose }, "×")), /* @__PURE__ */ import_react.default.createElement("div", { className: "ice-dialog-content" }, children), footer !== null && /* @__PURE__ */ import_react.default.createElement("div", { className: "ice-dialog-footer" }, footer || /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("button", { className: "ice-dialog-btn ice-dialog-btn-default", onClick: handleClose }, "Cancel"), /* @__PURE__ */ import_react.default.createElement("button", { className: "ice-dialog-btn ice-dialog-btn-primary", onClick: handleOk }, "Confirm"))))
    );
  };
