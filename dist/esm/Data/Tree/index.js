...
var Tree = function Tree(_ref) {
    ...
    function (node) {
      ...
      if (accordion) {
        ...
        newExpandedKeys = isExpanded
          ? internalExpandedKeys.filter(function (k) {
              return k !== key;
            })
    ...
    function (node) {
      ...
      if (multiple) {
        newSelectedKeys = isSelected
          ? internalSelectedKeys.filter(function (k) {
              return k !== key;
            })
  ...
  var handleCheck = useCallback(
    function (node) {
      ...
      if (isChecked) {
        ...
        // 选中时，添加当前节点和所有子节点
        newCheckedKeys = [].concat(
          _toConsumableArray(internalCheckedKeys),
          [key],
          _toConsumableArray(childKeys),
        );
        ...
        parentKeys.forEach(function (parentKey) {
          var _findNode;
          var parentNode =
            (_findNode = findNode(parentKey, treeData)) === null || _findNode === void 0
              ? void 0
              : _findNode.node;
          if (parentNode) {
  ...
  var renderTreeNode = function renderTreeNode(node) {
    ...
    var isDragOver =
      (dragOverNode === null || dragOverNode === void 0 ? void 0 : dragOverNode.key) === key;
  ...
  var filteredData = filterValue
    ? treeData.filter(function (node) {
        var _node$title;
        var title =
          ((_node$title = node.title) === null || _node$title === void 0
            ? void 0
            : _node$title.toString().toLowerCase()) || '';
