...
var Input = (props) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement(
    ...
    type === 'password' &&
      /* @__PURE__ */ import_react.default.createElement(
        'span',
        { className: 'ice-input-password-toggle', onClick: togglePasswordVisibility },
        showPassword ? '👁️' : '👁️‍🗨️',
      ),
    allowClear &&
      inputValue &&
      ...
      /* @__PURE__ */ import_react.default.createElement(
        'span',
        { className: 'ice-input-clear', onClick: handleClear },
        '✕',
      ),
    type === 'search'
      ? /* @__PURE__ */ import_react.default.createElement(
          'span',
          {
            ...
            onClick: () => (onSearch == null ? void 0 : onSearch(inputValue)),
          },
          '🔍',
        )
      : suffix &&
