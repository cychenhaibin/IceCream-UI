...
var Tooltip = (props) => {
  const { title, children, placement = 'top', trigger = 'hover', className, style } = props;
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    visible &&
      /* @__PURE__ */ React.createElement(
        'div',
        { ref: tooltipRef, className: classes },
        /* @__PURE__ */ React.createElement('div', { className: `${tooltipPrefix}-arrow` }),
        /* @__PURE__ */ React.createElement(
          'div',
          { className: `${tooltipPrefix}-content` },
          title,
        ),
      ),
  );
